...
! modified by alessia to act on files containing multiple streams of data
...
!
  ...
  double precision, dimension(:,:), allocatable :: sem, sem_fil
...
! allocate arrays
  allocate(time(nlines),sem(nlines,ncols),sem_fil(nlines,ncols))
