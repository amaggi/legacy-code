...
c   greens functions will be output
      include '/dione/Codes/SWcodes/common_files/sizes.inc'
      include '/dione/Codes/SWcodes/common_files/commons.inc'
      include '/dione/Codes/SWcodes/common_files/units.inc'
