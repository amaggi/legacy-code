...
!
!  This version reads in fully 4theta models, but currently ignores
!  the 4theta parts (a3, a4)
!=====================================================================
...
module three_d_mantle_model_variables
  ...
  double precision grid_a3(1:NLAT,1:NLON,0:NLAY)
  double precision grid_a4(1:NLAT,1:NLON,0:NLAY)
...
!-----------------
  ...
  subroutine read_mantle_model_4theta
  ...
  do k=1,NLAY
    ...
    enddo
    do j=1,NLAT
      read(11,*) (grid_a3(j,i,k),i=1,NLON) 
    enddo
    do j=1,NLAT
      read(11,*) (grid_a4(j,i,k),i=1,NLON) 
    enddo
...
666 continue
  ...
  end subroutine read_mantle_model_4theta

!---------------------------


  subroutine mantle_model_4theta(radius,theta,phi,dvs,alpha,am_phi,ampG)
  ...
  end subroutine mantle_model_4theta
