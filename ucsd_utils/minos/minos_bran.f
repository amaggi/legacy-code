...
c*** find roots ***
   40 knsw=0
      maxo=8
      call rotspl(eps1,wt,iout,ioeig,ifreq)
   10 continue
   50 continue
      return
      end

      subroutine rotspl(eps1,wt,iout,ioeig,ifreq)
...
c*** write out frequencies ***
   65 call detqn(b,knt,fb,ifreq)
      ...
      if(ifreq.eq.1) then
        ...
        print 200,nord,ichar(jcom),l,cvel,wmhz,tcom,gcom,qmod,wdiff
...
c*** we estimate group velocity using previous frequencies
        ...
        gcom=vn*cg/1000.d0
        print 200,nord,ichar(jcom),l,cvel,wmhz,tcom,gcom
     ...
     +  fl1,fl2,fl3,sfl3,jcom,nord,l,kg,kount,knsw,ifanis,iback
      ...
      common/buf$/nn,ll,ww,qq,gc,buf(6*mk)
